...
public class MaxKnapsack {
    ...
    /**
     * Class with the intention of resolve the problem, it receive a knapsack to
     * put itens on , a list of itens and it will construct a value table with
     * it , to find what is the ideal value to put in the bag. Later we find the
     * itens that match the value
     *
     * @author fabio
     */
